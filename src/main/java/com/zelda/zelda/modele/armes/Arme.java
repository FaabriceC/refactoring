...
public abstract class Arme {
    ...
    public void attaqueAvecArme(Monstre monstre){
        ...
        if(attaquePossibleSelonDirection(link.getDerniereDirection(),monstre,currentTime)){
            ...
            if(monstrePeutReculerSelonDirection(link.getDerniereDirection(),monstre)){
                this.reculDuMonstreSelonDirection(link.getDerniereDirection(),monstre);
            }
    ...
    public void reculDuMonstreSelonDirection(int direction,Monstre monstre){
        if(direction == 1){
