 ...
 */
    ...
    public void initListObs(){
        ...
        ListChangeListener<Projectile> projectileListChangeListener = new ListObsProjectile(panneauJeu);
        Environnement.getInstance().getProjectiles().addListener(projectileListChangeListener);
